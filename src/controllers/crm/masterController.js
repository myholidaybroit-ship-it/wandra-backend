...
export const hotels = crudFactory(Hotel, { searchable: ['name', 'city', 'roomTypes', 'destination'], filters: ['destination'], uploadFields: ['image'], uploadFolder: 'hotels' })
export const cabs = crudFactory(Cab, { searchable: ['name', 'type'], filters: ['status'], uploadFields: ['image'], uploadFolder: 'cabs' })
export const services = crudFactory(ServiceLocation, { searchable: ['name', 'serviceType', 'city', 'destination'], filters: ['destination'], uploadFields: ['image'], uploadFolder: 'services' })
export const activities = crudFactory(Activity, { searchable: ['name', 'category', 'city', 'destination'], filters: ['destination'], uploadFields: ['image'], uploadFolder: 'activities' })
